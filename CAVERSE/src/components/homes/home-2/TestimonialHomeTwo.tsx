                                ...
                                className="swiper testimonial-slider-2 mt-3 mt-md-0">
                                        ...
                                        <SwiperSlide className="swiper-slide">
                                            <div className="content">
                                                ...
                                                <h3>
                                                    "The Test Series were great and follow them to get your dreams comes true"
                                                </h3>
                                        ...
                                        <SwiperSlide className="swiper-slide">
                                            <div className="content">
                                                ...
                                                <h3>
                                                    "The Test Series content is easy to follow and Mentors were available answer questions "
                                                </h3>
                                                <div className="client-info">
                                                    <h4>Sakshi Jain</h4>
                                                    <p></p>
                                        ...
                                        <SwiperSlide className="swiper-slide">
                                            <div className="content">
                                                ...
                                                <h3>
                                                    "It was my great experience with CaVerse Test Series "
                                                </h3>
                                                <div className="client-info">
                                                    <h4>Ansh Agrawal</h4>
                                                    <p></p>
                                        ...
                                        <SwiperSlide className="swiper-slide">
                                            <div className="content">
                                                ...
                                                <h3>
                                                    "Best Ever Test Series on Internet for CA preparation"
                                                </h3>
                                                <div className="client-info">
                                                    <h4>Harshita </h4>
                                                    <p></p>
                        ...
                        <div className="col-xxl-4 col-xl-5 col-lg-5 d-none d-md-block">
                            <div className="testimonial-image-items">
                                <div className="box-shape">
                                    <img src="assets/img/testimonial/box-shape.png" alt="img" height="300" width="600" />
                                </div>
                                <div className="row g-4">
                                    <div className="col-md-6 col-sm-6">
                                        <div className="client-img-1 bg-cover" style={{background: `url(/assets/img/testimonial/01.jpg)`,height: "250",width: "400"}}></div>
