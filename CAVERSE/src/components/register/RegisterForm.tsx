...
const RegisterForm: React.FC<RegisterFormProps> = ({ onRegisterSuccess }) => {
  // Line 10: destructure `register` instead of `login`
const { register } = useAuth();
 ...
 // In handleSubmit, replace the login() call with register():
  ...
  if (validateForm()) {
    ...
    setTimeout(async () => {
      try {
        ...
        alert(
          `Welcome to CaVerse, ${formData.firstName}! Your account has been created successfully.`,
        );
      ...
      >
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>
          ...
          >
            ...
            >
              By creating an account, you agree to CaVerse's Terms of Service
              and Privacy Policy.
              <br />
              Get access to expert mentorship, comprehensive test series, and
